...
if __name__ == "__main__":
    ### 单个文件夹下多个目录
    root1 = '/home/winner/chenwf/datasets/pdv_finetune'
    root2 = '/home/winner/chenwf/datasets/pdv_scratchv2_70w'
    ...
    for (p1,p2) in zip(path1s,path2s):
        ...
        save_dir = os.path.join('/home/winner/chenwf/datasets/preVSfinetune',p1)
